...
In my last <span onclick="window.location.href='{% post_url 2014-6-30-reflecting-on-DBC %}'">post on DBC</span> I wrote about the programming skills DBC imparts to it's "boots."  The curriculum is well thought out and the pace of the program is fast but fun.  
