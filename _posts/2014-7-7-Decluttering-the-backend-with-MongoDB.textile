...
One of the weirdest things for a beginner coming from SQL to understand about MongoDB is the <pre><code>$unwind</code></pre> function.  It sounds like a strange add on that you wont need until you want to do something advanced but it's actually pretty central to using Mongo.
