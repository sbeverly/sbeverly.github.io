...
DBC cohorts are already comprised of a self-selected group of adventurous, tech savvy people who have put in a significant amount of time learning on their own.  We were able to take those pre-existing qualities to the next level with the help of industry pros providing us with constant feedback and making sure that we were hitting the required benchmarks to be succesful.  I can’t belive how much I learned in this intense experience and only look forward to learning more.
